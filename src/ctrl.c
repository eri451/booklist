...
void sortTheList(tList* list, int by_field, int in_order)    /* um die selbe list sortiert zur�ck zu geben */
{
    ...
    DeleteList(list);                                       /* um speicher fehler zu verhindern "sauber" l�schen*/
    list = CreateList();                                    /* neuen speicherplatz f�r die liste bereitstellen*/
